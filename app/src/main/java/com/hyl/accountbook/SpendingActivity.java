...
import com.hyl.fragment.OneFragment;
import com.hyl.fragment.TwoFragment;
 ...
 */
public class SpendingActivity extends BaseActivity implements View.OnClickListener {
    ...
    String[] titles = new String[]{"明细"};
    private static final String[] yearList = {pubFun.getTime("Y")+"年"};
    private static final String[] monthList = { "Jan", "Feb", "Mar", "Apr", "May", "June", "July", "Aug", "Sept", "Oct", "Nov", "Dec" };
...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    private void initViews() {
        ...
        float sum_out=0;
        //改进：分帐户计算总收入总支出
        List<records> Records = DataSupport.findAll(records.class);
        for (records Record: Records){
            if(Record.getType()==0){
                sum_in = sum_in + Record.getAmount();//计算总收入
            }
            else if(Record.getType()==1){
                sum_out = sum_out + Record.getAmount();//计算总支出，不含转账
            }
        }

        tv_income_money = (TextView) findViewById(R.id.tv_income_money);
        tv_income_money.setText(Float.toString(sum_in));

        tv_outlay_money = (TextView) findViewById(R.id.tv_outlay_money);
        tv_outlay_money.setText(Float.toString(sum_out));
        ////////////////////////////////////////////////////////
        ...
        alertBuilder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(i!=2) {
                    ...
                    Intent intent = new Intent(SpendingActivity.this, TransferActivity.class);
                    intent.putExtra("strType", i);
                    SpendingActivity.this.startActivity(intent) ;
                    finish();
                    alertDialog_AddRecord.dismiss();
